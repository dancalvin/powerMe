  ...
  return (
    <>
      ...
      >
        ...
        <div className="form">
          <h3 className="med h3">Height</h3>
          <h3 className="med h3">Feet</h3>
          ...
          <h3 className="med h3">Weight (lbs)</h3>
          <div className="input__measure">
            <input
              type="number"
              className="input"
          ...
          <h3 className="med h3">Waist Circumference (in)</h3>
          <h3 className="light h3">
      ...
      {type == "1" ? (
        <>
          <button
            type="button"
            className="button primary max-[540px]:!w-full"
            disabled={!isValid}
            onClick={nextTab}
          >
            Continue
          ...
          <button
            type="button"
            className="button primary clearDT back max-[540px]:!w-full"
            onClick={prevTab}
          >
            Back
          </button>
