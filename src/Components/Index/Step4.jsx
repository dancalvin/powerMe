  ...
  return (
    <>
      <div className="step fourth">
        <h2>Lab Values</h2>
        <h3 className="light">
          The values related to blood cholesterol are indicative of your risk
          for cardiovascular disease. Your overall risk for high cholesterol
          depends on many factors. If you know your numbers, please enter them
          below. If not, feel free to estimate using the numbers within the
          normal range or <a href="#">click here</a> to learn about the PowerME
          Diagnostics Metabolic Health Report.
        </h3>
        <div className="form">
