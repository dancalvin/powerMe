    ...
    <div className="max-w-none mt-0 w-full px-0 lg:mb-8 ">
      <div className="m-auto max-w-[1080px]">
        <div className="overflow-hidden bg-primary text-center sm:bg-transparent">
          <H1 no={5}>Vitality History</H1>
        </div>

        <div>
          {/* line graph for vitality score data */}
          <VitalityStatsBlock
          ...
          <div className="relative mt-[60px] px-5 sm:px-0">
            ...
            {/* vitality score history data for each visit */}
...
function DeletePopup(props) {
  ...
  return (
    <div className="fixed top-0 left-0 bottom-0 right-0 flex items-center justify-center">
      ...
      <div className="max-w-5xl relative z-10 mx-5 w-full bg-secondary py-10 px-10 md:py-16 md:px-20">
        <div
