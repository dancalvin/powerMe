...
import { ArrowBack, ArrowForward } from "../../../components/Svgs";
...
export default function VitalityStatsBlock(props) {
  ...
  return (
    <div className="bg-secondary sm:border-[1px]">
      <div>
        {/* tabs */}
        <div className="max-w-none flex w-full flex-row flex-nowrap">
          <div
        ...
        <div className="py-8 px-5 sm:px-12 sm:py-10">
          ...
          {/* move forward or backward with time */}
          ...
          <div className="mt-5 text-center font-montserrat text-xl leading-6 text-black underline">
            <p
              ...
              onClick={() => props.setAddDataPopupToggle(true)}
            >
              Add historical data
            </p>
          </div>
