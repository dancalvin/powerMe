...
import { ArrowBack, ArrowForward, BackForward } from "../../../components/Svgs";
...
export default function HeartFitStatsBlock(props) {
  ...
  return (
    <div className="bg-secondary sm:border-[1px]">
      <div>
        {/* tabs */}
        <div className="history__tabs max-w-none flex w-full flex-row flex-nowrap">
          <div
          ...
          >
            ...
            >
              <span className="">Heart-Fit Goals</span>
            </p>
          </div>
        </div>
